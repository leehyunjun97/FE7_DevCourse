...
// 1.2 타입 -> 데이터의 종류를 의미한다.
// 1.3 타입스크립트는 자바스크립트의 슈퍼셋(superset)이다
// 1.3.1 슈퍼셋은 어떤 집합이나 시스템이 다른 집합이나 시스템을 모두 포함하면서 추가적인 요소를 더 가지고 있는 것을 말함
...
// 2.1.1 <script type="module" scr="..." />

// 2.2 최신 설정을 바꾸는 방법
// 2.2.1 isolatedModules -> false
// 2.2.2 moduleDetection -> "auto"
// 2.2.3 <script defer scr="..."/>

// 2.3 5.8 버젼의 추천 설정을 사용하기 (강의 노트)
